    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('united_state', 'United State'), ('india', 'India'), ('japan', 'Japan'), ('canada', 'Canada'), ('united_kingdom', 'United Kingdom')], db_index=True, default='United State', max_length=25, verbose_name='Country')),
